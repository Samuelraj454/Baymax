...
INTENT_PATTERNS = {
    "music":      [r"play\b",r"songs?\b",r"music\b",r"youtube\b",
                   r"spotify\b",r"put on\b",r"listen\b"],
    "system":     [r"open\b",r"\blaunch\s+(?!space\b)\w+",r"chrome\b",r"firefox\b",
    ...
    "email":      [r"emails?\b",r"mail\b",r"inbox\b",r"compose\b"],
    "whatsapp":   [r"whatsapp\b",r"whats.?app\b",r"send.*message"],
    "news":       [r"news\b",r"headlines?\b",r"happening\b",r"latest\b"],
    "calendar":   [r"schedul\b",r"meetings?\b",r"calendar\b",
                   r"appointment\b",r"book\b"],
    "notes":      [r"notes?\b",r"write.*down",r"remember this",
                   r"save this",r"jot\b"],
    "translate":  [r"translat",r"how.*say\b",r"in.*language\b"],
    "calculator": [r"\d+.*[\+\-\*\/].*\d+",r"calculat",
